...
class aplicacion_ruido(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.amp_ruido = amp_ruido = 0.25

        ##################################################
        # Blocks
        ##################################################

        self._amp_ruido_range = qtgui.Range(0, 2, 0.05, 0.25, 200)
...
def main(top_block_cls=aplicacion_ruido, options=None):
